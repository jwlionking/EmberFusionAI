Contributing to EFUS Core
============================

The EFUS Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/EFUSTECH/EFUS/issues)
list.
...
[Translation Process](https://github.com/EFUSTECH/EFUS/blob/master/doc/translation_process.md)
...
The following applies to code changes to the EFUS Core project (and related
projects such as libsecp256k1), and is not to be confused with overall EFUS
Network Protocol consensus changes.

Whether a pull request is merged into EFUS Core rests with the project merge
...
Patches that change EFUS consensus rules are considerably more involved than
...
Where a patch set proposes to change the EFUS consensus, it must have been
...
The review process is normally fairly responsive on the EFUS Core repository, however
...
Bitcoin Backports are an incredibly valuable part of EFUS's development. Backporting allows us to easily implement new
features, improvements and fixes as bitcoin implements them.

To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for EFUS](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).
...
The project leader is the release manager for each EFUS Core release.
