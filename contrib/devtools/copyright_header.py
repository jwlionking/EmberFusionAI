...
Arguments:
    <base_directory> - The base directory of a EFUS Core source code repository.
...
Arguments:
    <base_directory> - The base directory of EFUS Core source code repository.
"""
...
Arguments:
    <file> - A source file in the EFUS Core repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The EFUS
