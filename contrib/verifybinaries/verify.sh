...
RCSUBDIR="test"
HOST1="https://github.com/EFUSTECH/EFUS/releases/"
HOST2="https://pasta.keybase.pub/EFUS-Core-Releases/"
BASEDIR=""
VERSIONPREFIX=""
RCVERSIONSTRING="rc"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the EFUS Core binary release signing key installed?"
   fi
