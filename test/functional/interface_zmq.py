...
from test_framework.messages import efushash
...
def efushash_helper(b):
    return encode(efushash(b)[::-1], 'hex_codec').decode('ascii')
...
class ZMQTest (BitcoinTestFramework):
    ...
    def _zmq_test(self):
        ...
        for x in range(num_blocks):
            ...
            assert_equal(genhashes[x], efushash_helper(block[:80]))
