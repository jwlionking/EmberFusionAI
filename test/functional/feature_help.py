...
"""Verify that starting efusd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start efusd with -h for help text")
        ...
        self.log.info("Start efusd with -version for version information")
        ...
        self.log.info("Start efusdd with -fakearg to make sure it does not start")
