# Support for Output Descriptors in EFUS Core

Since EFUS Core v0.17, there is support for Output Descriptors. This is a
...
existing EFUS Core wallets, a convenience function `combo` is
...
All RPCs in EFUS Core will include the checksum in their output. Only
