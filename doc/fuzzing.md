# Fuzzing EFUS Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing EFUS Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/EFUSTECH/EFUS
$ make
...
[`process_message`](https://github.com/EFUSTECH/EFUS/blob/develop/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/EFUSTECH/EFUS/blob/develop/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/efuspay/efus/tree/develop/src/test/fuzz).
...
Every single pull request submitted against the EFUS Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make EFUS Core more robust.
...
with certain assembly code from EFUS Core's code. See [developer notes on sanitizers](https://github.com/EFUSTECH/EFUS/blob/develop/doc/developer-notes.md#sanitizers)
...
# Fuzzing EFUS Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing EFUS Core using [`afl-fuzz`](https://github.com/google/afl):
...
# Fuzzing EFUS Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing EFUS Core using [Honggfuzz](https://github.com/google/honggfuzz):
