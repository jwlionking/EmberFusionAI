...
This document provides guidelines for internationalization of the EFUS Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `efus_en.ts` remains unchanged.
