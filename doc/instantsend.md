...
This mechanism has been integrated into Bitcore-Node-EFUS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/efuspay/insight-api-efus#web-socket-api](https://github.com/efuspay/insight-api-efus#web-socket-api)
* API: [https://github.com/efuspay/insight-api-efus#instantsend-transactions](https://github.com/efuspay/insight-api-efus#instantsend-transactions)
