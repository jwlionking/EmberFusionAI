...
#ifndef EFUS_CRYPTO_BLS_H
#define EFUS_CRYPTO_BLS_H
...
// bls-efus uses relic, which may define DEBUG and ERROR, which leads to many warnings in some build setups
#undef ERROR
#undef DEBUG
#include <efusbls/bls.hpp>
#include <efusbls/privatekey.hpp>
#include <efusbls/elements.hpp>
#include <efusbls/schemes.hpp>
#include <efusbls/threshold.hpp>
#undef DOUBLE
#undef SEED
