...
//! Interface for the src/evo part of a efus node (efusd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a efus node (efusd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a efus node (efusd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a efus node (efusd process).
...
//! Top-level interface for a efus node (efusd process).
class Node
{
public:
    virtual ~Node() {}
