...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"efus\" activates all EFUS-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "efus")
    + HelpExampleRpc("debug", "efus+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given efus address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The efus address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The efus address to use for the signature."},
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "efus-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* EFUS features */
    { "efus",               "mnsync",                 &mnsync,                 {} },
    { "efus",               "spork",                  &spork,                  {"command"} },
    { "efus",               "sporkupdate",            &sporkupdate,            {"name","value"} },
