...
/** Utility functions used by the EFUS Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "efus:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load efus specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a efus specific theme is activated (light/dark).*/
