...
;(function() {
  ...
  function runInContext(context) {
    // Exit early if unable to acquire loefus.
    var _ = context && context._ || require('loefus') || root._;
    if (!_) {
     ...
     *
     * Note: The Benchmark constructor exposes a handful of loefus methods to
     * make working with arrays, collections, and objects easier. The loefus
     * methods are:
     * [`each/forEach`](https://loefus.com/docs#forEach), [`forOwn`](https://loefus.com/docs#forOwn),
     * [`has`](https://loefus.com/docs#has), [`indexOf`](https://loefus.com/docs#indexOf),
     * [`map`](https://loefus.com/docs#map), and [`reduce`](https://loefus.com/docs#reduce)
     *
     * @constructor
     ...
     *
     * Note: Each Suite instance has a handful of wrapped loefus methods to
     * make working with Suites easier. The wrapped loefus methods are:
     * [`each/forEach`](https://loefus.com/docs#forEach), [`indexOf`](https://loefus.com/docs#indexOf),
     * [`map`](https://loefus.com/docs#map), and [`reduce`](https://loefus.com/docs#reduce)
     *
     * @constructor
     * @memberOf Benchmark
    ...
    // Add loefus methods to Benchmark.
    ...
    // Add loefus methods as Suite methods.
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    define(['loefus', 'platform'], function(_, platform) {
      return runInContext({
        '_': _,
        'platform': platform
      });
